...
urlpatterns = [
    ...
    path('get_details/', views.get_details, name='get_tournament_details'),
    path('join_tournament/<int:pk>/', views.join_tournament, name='join_tournament'),
    path('show_products_api/', views.show_products_api),
]
